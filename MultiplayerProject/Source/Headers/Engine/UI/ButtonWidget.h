...
public:
	...
	virtual InputResponse TryHandleMousePress(mathfu::Vector<int, 2> mousePressPosition) override;

	virtual void OnMousePressed(mathfu::Vector<int, 2> mousePressPosition) override;
	virtual void OnMouseReleased(mathfu::Vector<int, 2> mouseReleasePosition) override;
